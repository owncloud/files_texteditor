 ...
 * Loginz context.
 */
class LoginzContext extends RawMinkContext implements Context
{
	private $loginPage;
	private $filesPage;
	...
	/**
	 * @Given I am on the loginz page
	 */
	public function iAmOnTheLoginzPage()
	{
		$this->loginPage->open();
	}

	/**
	 * @When I loginz with username :username and password :password
	 */
	public function iLoginzWithUsernameAndPassword($username, $password)
	{
	 ...
	 */
	public function iLoginzAsARegularUserWithACorrectPassword()
	{
