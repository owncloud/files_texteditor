OC.L10N.register(
    ...
    "Cannot save file as it is locked by %s." : "%s tarafından kilitlendiği için dosya kaydedilemiyor.",
    ...
    "Public Link User via Text Editor" : "Metin Düzenleyici aracılığıyla Genel Bağlantı Kullanıcısı",
    "%s via Text Editor" : "Metin Editörü aracılığıyla %s",
    "saving..." : "kaydediliyor...",
    "saved!" : "kaydedildi!",
    ...
    "Editor has not been closed. Changes might be lost and file will remain locked for editing" : "Editör kapatılmadı. Değişiklikler kaybolabilir ve dosya düzenleme için kilitli kalır",
    "Open in Text Editor" : "Metin Editöründe Aç",
    "An error occurred!" : "Hata oluştu!",
    "file is read-only, locked by {locked}" : "dosya sadece okunabilir, {locked} tarafından kilitlendi",
    "file is read-only" : "dosya sadece okunabilir",
